...
class MultiviewImgDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, root_dir, scale_aug=False, rot_aug=False, test_mode=False, num_models=0, num_views=1, shuffle=True):
        ...
        for i in range(len(self.classnames)):
            path = parent_dir + '/' + self.classnames[i] + '/' + set_ + '/*.png'
